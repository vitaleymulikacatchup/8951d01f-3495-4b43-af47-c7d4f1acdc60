...
export const metadata: Metadata = {
  title: "Grandeur Hotel - Luxury Accommodations & World-Class Service",
  description: "Experience five-star luxury at Grandeur Hotel. Premium rooms, fine dining, spa services, and exceptional hospitality in the heart of the city.",
  keywords: "luxury hotel, five star accommodation, premium rooms, fine dining, spa services, city hotel, business travel, luxury suites",
  openGraph: {
    title: "Grandeur Hotel - Luxury Accommodations & World-Class Service",
    description: "Experience five-star luxury at Grandeur Hotel. Premium rooms, fine dining, spa services, and exceptional hospitality in the heart of the city.",
    ...
    images: [
      {
        ...
        alt: "Luxury hotel lobby with elegant décor and ambient lighting"
      }
    ]
  },
  twitter: {
